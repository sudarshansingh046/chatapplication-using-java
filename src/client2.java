...
public class client2 extends javax.swing.JFrame implements Runnable {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("VASUDEV DADHICH");
...
private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
    ...
    String msg="Vasudev: "+t1.getText()+e;
    bw.write(msg);
    bw.write("\r\n");
    bw.flush();
    ...
    Connection con=(Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/chat","root","");  // connection
        ...
        PreparedStatement ps = (PreparedStatement) con.prepareStatement("insert into client2 values('Vasudev',?)");
